...
SELECT nombre AS "nombre de producto", precio AS euros, precio * 1.06 AS dólares FROM producto;
...
SELECT p.codigo_fabricante, p.nombre, f.codigo, f.nombre FROM producto p, fabricante f WHERE p.codigo_fabricante = f.codigo;

#4. Devuelve el nombre del producto, su precio y el nombre de su fabricante, del producto más barato.

SELECT p.nombre, p.precio, f.nombre FROM producto p, fabricante f WHERE p.codigo_fabricante = f.codigo ORDER BY p.precio ASC LIMIT 0,1;

#5. Devuelve el nombre del producto, su precio y el nombre de su fabricante, del producto más caro.

SELECT p.nombre, p.precio, f.nombre FROM producto p, fabricante f WHERE p.codigo_fabricante = f.codigo ORDER BY p.precio DESC LIMIT 0,1;

#6. Devuelve una lista de todos los productos del fabricante Lenovo.

SELECT DISTINCT p.* FROM producto p, fabricante f WHERE p.codigo_fabricante = f.codigo AND f.nombre LIKE "Lenovo";

#7. Devuelve una lista de todos los productos del fabricante Crucial que tengan un precio mayor que 200€.

SELECT DISTINCT p.* FROM producto p, fabricante f WHERE p.codigo_fabricante = f.codigo AND f.nombre LIKE "Crucial" AND p.precio > 200;
...
SELECT COUNT(*) FROM producto p INNER JOIN fabricante f ON f.codigo = p.codigo_fabricante WHERE f.nombre = "Asus";

#11. Calcula la media del precio de todos los productos del fabricante Asus.

SELECT AVG(precio) FROM producto p INNER JOIN fabricante f ON f.codigo = p.codigo_fabricante WHERE f.nombre = "Asus";

#12. Calcula el precio más barato de todos los productos del fabricante Asus.

SELECT MIN(precio) FROM producto p INNER JOIN fabricante f ON f.codigo = p.codigo_fabricante WHERE f.nombre = "Asus";

#13. Calcula el precio más caro de todos los productos del fabricante Asus.

SELECT MAX(precio) FROM producto p INNER JOIN fabricante f ON f.codigo = p.codigo_fabricante WHERE f.nombre = "Asus";

#14. Calcula la suma de todos los productos del fabricante Asus.

SELECT SUM(precio) FROM producto p INNER JOIN fabricante f ON f.codigo = p.codigo_fabricante WHERE f.nombre = "Asus";

#15. Muestra el precio máximo, precio mínimo, precio medio y el número total de productos que tiene el fabricante Crucial.

SELECT MAX(precio), MIN(precio), AVG(precio), COUNT(*) FROM producto p INNER JOIN fabricante f ON f.codigo = p.codigo_fabricante WHERE f.nombre = "Crucial";
...
SELECT f.nombre, COUNT(p.nombre) FROM fabricante f LEFT JOIN producto p ON f.codigo = p.codigo_fabricante GROUP BY f.nombre;
...
SELECT f.nombre, MAX(p.precio), MIN(p.precio), AVG(p.precio) FROM fabricante f LEFT JOIN producto p ON f.codigo = p.codigo_fabricante GROUP BY f.nombre;
